      ...
      <div className='wrapper'>
        <div className='column about' id='about'>
          ...
          <div className='about-links'>
            <a href='https://github.com/shanole/moodcloud' target="_blank" rel="noreferrer">see source code on github</a>
            <a href='https://www.linkedin.com/in/shannonhjlee/' target="_blank" rel="noreferrer">contact Shannon on linkedin</a>
          </div>
        </div>
